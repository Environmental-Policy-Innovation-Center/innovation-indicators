...
get_repo_details <- function(org_name, agency, github_token) {
  ...
  headers <- add_headers(Authorization = paste("github_token", github_token))
...
agencies <- data.frame(agencylist <- c("Forest Service","Natural Resources Conservation Service","U.S. Fish and Wildlife Service","National Park Service","U.S. Geological Survey","Bureau of Land Management","Environmental Protection Agency", "Bureau of Reclamation", "U.S. Army Corps Of Engineers"),github_org = c("USDAForestService", "USDA-NRCS", 
                 "USFWS", "nationalparkservice", "USGS", 
                 "doi-blm", "usepa", "doi-bor", 
                 "USACE"))

## NOAA 
noaa <- data.frame(github_org = c("NOAA-PMEL","NOAA-CSL","NOAA-GSL","NOAA-EMC","NOAA-PSL","NOAA-ERD","NOAA-GFDL","NOAA-EDAB","NOAA-AOML","NOAA-GLERL","NOAA-OCS","NOAA-OCM","nmfs-fish-tools","NOAA-MDL","NOAA-OWP","NOAA-Fisheries-OST","NOAA-SWPC","NOAA-CO-OPS","NOAA-NCEI","NOAA-PIFSC","NOAA-NGS","MSE-NCCOS-NOAAE","NOAA-GML","HABF-SDI-NCCOS-NOAA","NOAA-Omics","noaa-ncai"))
...
## Summary Stats and Langauges Data
```{r}
...
language_summary_long <- repo_details_final_fy22_fy24 %>%
    ...
    group_by(sub_agency, repository, languages) %>%
...
no_lang <- c('HTML', 'Makefile', 'Dockerfile', 'Jupyter Notebook','Batchfile', 'M4','Procfile', 'Vue', 'Smarty', 'CMake',
            'JavaScript', 'CSS',"SCSS",'Shell', 'TeX', "Inno Setup","PowerShell", "Roff","Rich Text Format","Jinja","BitBake","ASP.NET","Pug","QMake","Stylus", "Less", "Mako", "SWIG", "Twig", "EJS", "PEG.js", "Handlebars", "Module Management System", "LLVM", "FreeMarker")
...
epic_chart_theme <- theme_minimal() + 
  theme(legend.position = "right", 
       # text = element_text(size = 13, family = "Lato"), 
        ...
        axis.text.x = element_text(size = 12, margin = margin(t = 10, r = 0, 
                                                   b = 0, l = 0), face = "bold"), 
...
cat_palette_pastel <- colorRampPalette(c("#526489", "#B077B2", 
                                         "#82AB6E", "#E4BE7C", 
                                         "#b15712", "#A3D9A5"))
...
set.seed(124) # Optional for reproducibility
...
ggplot(languages_bar_agency_5, aes(fill = languages, y = count, x = sub_agency_abbrev)) +
